...
const serviceGroups: ServiceGroup[] = [
  {
    ...
    services: [
      {
        title: "GST Services",
        description: "GST registration, return filing, payment, ARN status aur helpdesk.",
        tag: "GST",
        popular: true,
        aliases: ["gst number", "gst return", "gstr", "business registration"],
        icon: Store,
        subLinks: [
          { title: "GST Login / Filing", href: "https://services.gst.gov.in/services/login" },
          { title: "New GST Registration", href: "https://reg.gst.gov.in/registration/" },
          { title: "Track ARN Status", href: "https://services.gst.gov.in/services/arnstatus" },
          { title: "Search Taxpayer", href: "https://services.gst.gov.in/services/searchtpbypan" },
          { title: "GST Helpdesk (Grievance)", href: "https://selfservice.gstsystem.in/" },
          { title: "e-Way Bill Portal", href: "https://ewaybillgst.gov.in/" },
        ]
      },
      {
        title: "FSSAI (Food Licence) Services",
        description: "FSSAI FoSCoS basic registration, state/central licence, renewal aur annual return.",
        tag: "FSSAI",
        popular: true,
        aliases: ["food licence", "foscos", "fssai license"],
        icon: Utensils,
        subLinks: [
          { title: "Apply New Licence/Registration", href: "https://foscos.fssai.gov.in/apply-for-lic-and-reg" },
          { title: "FoSCoS Login (Renewal/Return)", href: "https://foscos.fssai.gov.in/" },
          { title: "Track Application Status", href: "https://foscos.fssai.gov.in/track-application-status" },
        ]
      },
    ],
  },
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        description: "e-Aadhaar download, PVC order, update status, biometric lock, aur verify services.",
        tag: "UIDAI",
        popular: true,
        aliases: ["uidai", "e aadhaar", "adhar", "aadhar"],
        icon: CreditCard,
        subLinks: [
          { title: "Access Official Portal", href: "https://myaadhaar.uidai.gov.in/verifyAadhaar" },
          { title: "Download E-Aadhaar", href: "https://myaadhaar.uidai.gov.in/genricDownloadAadhaar/en" },
          { title: "Face Aadhaar Download", href: "https://akprinthub.com/en/service/aadhaar-card-download-by-face-without-otp-2026" },
          { title: "Check Aadhaar Mobile Link", href: "https://myaadhaar.uidai.gov.in/check-aadhaar-validity" },
          { title: "Find Aadhaar / EID", href: "https://myaadhaar.uidai.gov.in/retrieve-eid-uid/en" },
          { title: "Find / Generate VID", href: "https://myaadhaar.uidai.gov.in/genericGenerateOrRetriveVID/en" },
          { title: "Aadhaar Correction App", href: "https://play.google.com/store/apps/details?id=in.gov.uidai.pehchaan&pcampaignid=web_share" },
          { title: "Verify Email / Mobile", href: "https://myaadhaar.uidai.gov.in/verify-email-mobile/en" },
          { title: "Update Status Check", href: "https://myaadhaar.uidai.gov.in/CheckAadhaarStatus/en" },
          { title: "Lock/Unlock Aadhaar", href: "https://myaadhaar.uidai.gov.in/lock-unlock-aadhaar/en" },
          { title: "Order PVC Card", href: "https://myaadhaar.uidai.gov.in/genricPVC/en" },
          { title: "Check PVC Status", href: "https://myaadhaar.uidai.gov.in/checkStatus/en" },
          { title: "Document Update Online", href: "https://myaadhaar.uidai.gov.in/du/en_IN" },
          { title: "Report Death of Member", href: "https://tathya.uidai.gov.in/access/login?role=resident" },
          { title: "Bank Seeding Status", href: "https://tathya.uidai.gov.in/access/login?role=resident" },
          { title: "Deactivation Status", href: "https://myaadhaar.uidai.gov.in/CheckDeathReportStatus/en" },
          { title: "Update Appointment", href: "https://bookappointment.uidai.gov.in/" },
          { title: "SMS Services", href: "https://uidai.gov.in/en/my-aadhaar/avail-aadhaar-services/aadhaar-services-on-sms.html" },
        ]
      },
      {
        title: "PAN Card Services",
        description: "NSDL, UTIITSL, Income Tax e-PAN aur PAN Correction portals.",
        tag: "PAN",
        popular: true,
        aliases: ["pan card", "nsdl", "uti", "epan", "correction"],
        icon: CreditCard,
        subLinks: [
          { title: "NSDL PAN Apply / Correction", href: "https://tinpan.proteantech.in/services/pan/pan-index.html" },
          { title: "NSDL e-PAN Download", href: "https://onlineservices.proteantech.in/paam/requestAndDownloadEPAN.html" },
          { title: "UTIITSL PAN Services", href: "https://www.pan.utiitsl.com/" },
          { title: "UTIITSL e-PAN Download", href: "https://www.pan.utiitsl.com/PAN_ONLINE/ePANCard" },
          { title: "Instant e-PAN (Income Tax)", href: "https://www.incometax.gov.in/iec/foportal/help/all-topics/e-filing-services/instant-e-pan" },
          { title: "Link Aadhaar to PAN", href: "https://eportal.incometax.gov.in/iec/foservices/#/pre-login/bl-link-aadhaar" },
        ]
      },
      {
        title: "e-Shram Card",
